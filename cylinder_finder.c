...
/*   Updated: 2022/09/01 13:46:45 by adesgran         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static double	get_t(t_cylindre *cylindre, t_line *line)
{
	t_coord		ra1;
	t_coord		s;
	t_coord		r0a1;
...
static int	check_collision(t_cylindre *cy, t_line *sline, t_line *line, double t)
{
	t_line		raya1;
	t_line		raya2;
